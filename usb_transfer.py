...
#Check if usb plugged in
if os.path.exists(usb_256) and os.path.exists(usb_2tb):
    print("Blink USB and Storage USB Detected")
...
elif not(os.path.exists(usb_256)):
    print("Blink usb not detected, insert then rerun")
elif not(os.path.exists(usb_2tb)):
    print("Backup USB not detected, insert then try again")
